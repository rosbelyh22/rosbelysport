...
<script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#flagSwitcher").click(function() {
             ...
             <script src="<?=base_url()?>js/script_carrito.js"></script>
    ...
    <!---Mercado Pago-->    
       ...
       <div class="register_account">
            ...
            <div class="wrap">
                ...
                <h4 class="title"><?=get_lang("carrito-compras")?></h4> 
                <img src="<?=base_url()?>images/paypal1.png" style=" width: 80px; height: 30px; " alt=""/>
                <img src="<?=base_url()?>images/mp.png" style=" width: 80px; height: 30px" alt=""/>
                <p class="m_text" style="color:#df8a13; "> <?=get_lang("forma-pago")?><p>  
                <div class='table-responsive' id='lista_carrito'></div>
