  ...
  <?=GetMenu()?>
       ...
       <div class="register_account">
            ...
            <div class="wrap">
                ...
                <h4 class="title" style="color: #df8a13;"><?=get_lang("mi-cuenta")?>: </h4> <h3> <?=$clientes[0]->nombre?></h3> <hr>
            ...
            <?php if (count($pedidos) <= 0) {
                echo "<p>".get_lang('texto-no-pedidos')." </p>";
            }else if(count($pedidos) > 0) { ?>
                <h4 class="title" style="color: #df8a13;"> <?=get_lang("pedido-numero")?>: <?=$pedidos[0]->numeropedido?> </h4>
                 <p><strong> <?=get_lang("pedido-estatus")?> : </strong><?=$pedidos[0]->estatus?> </p>
                <h3 class="title" style="color: #df8a13;"><?=get_lang("tus-productos")?>: </h3>
                
               
            
            <?php foreach ($productospedidos as $pp){ ?>
                <p>Nombre del Producto: <a href="<?=base_url()?>product_details/get/<?=$pp->tags?>"><?=$pp->nombre?></a></p>
            <p><?=get_lang("precio")?>: <?=$pp->precio?></p>
            <p><?=get_lang("marca")?>: <?=$pp->marca?></p>
            <p><?=get_lang("modelo")?>: <?=$pp->modelo?></p>
            <hr>  
