...
?>
	...
	<input type="hidden" id="id" name="id" value="<?=$obra[0]->id?>">
    <input type="hidden" name="model" id="model" value="obras_model">
	<label>
    	<div class="btn btn-success">
        Subir Imagen
        <input type="file" name="userfile" id="userfile" style="display:none">
        <input type="hidden" name="file_name" id="file_name">
        <input type="hidden" name="folder" id="folder" value="obras">
    ...
    <input type="button" name="btn-regresar" id="btn-regresar" value="Regresar" onClick="location.href='<?=base_url()."index.php/obras/lista_obras/".$obra[0]->idcategoria?>'" class="btn btn-warning">
