...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-02-2017 a las 13:55:20
...
CREATE TABLE IF NOT EXISTS `bss_configuracion_envio` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bss_metodo_pago` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bss_pedidos` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_alertas` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_carrito` (
...
CREATE TABLE IF NOT EXISTS `im_clientes` (
`id` int(11) NOT NULL,
  `nombre` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_configuracion` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_contenidos` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_galeria` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_galeria_categoria` (
`id` int(11) NOT NULL,
  `nombre` varchar(255) NOT NULL,
  `descripcion` text NOT NULL,
  `tags` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_listas` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_mensajes` (
`id` int(11) NOT NULL,
  `idcliente` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_menus` (
`id` int(11) NOT NULL,
  `nombre` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_menu_tipo` (
`id` int(11) NOT NULL,
  `nombre` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_modulos` (
`id` int(11) NOT NULL,
  `nombre` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_modulos_privilegios` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_noticias` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_noticias_categoria` (
`id` int(11) NOT NULL,
  `idpadre` int(11) NOT NULL,
  `nombre` varchar(255) NOT NULL,
  `tags` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_noticias_comentarios` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_noticias_galeria` (
`id` int(11) NOT NULL,
  `idnoticia` int(11) NOT NULL,
  `tipo` int(11) NOT NULL COMMENT '0=img; 1=video',
...
CREATE TABLE IF NOT EXISTS `im_obras` (
`id` int(11) NOT NULL,
  `idcategoria` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_obras_categoria` (
`id` int(11) NOT NULL,
  `idpadre` int(11) NOT NULL,
  `nombre` varchar(255) NOT NULL,
  `nombre_espanol` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_obras_colecciones` (
`id` int(11) NOT NULL,
  `nombre` varchar(255) NOT NULL,
  `nombre_espanol` varchar(255) NOT NULL,
  `tags` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_obras_galeria` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_pedidolinea` (
`id` int(11) NOT NULL,
  `idproducto` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_pedidos` (
`id` int(11) NOT NULL,
...
INSERT INTO `im_pedidos` (`id`, `numeropedido`, `total`, `iva`, `grantotal`, `estatus`, `idusuario`, `fechacreacion`) VALUES
(1, 2, 50000, 50, 50000, 1, 1, '0000-00-00');
...
CREATE TABLE IF NOT EXISTS `im_productos` (
`id` int(11) NOT NULL,
  `idcategoria` int(11) NOT NULL,
  `idcoleccion` int(11) NOT NULL,
  `tags` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_productos_categoria` (
`id` int(11) NOT NULL,
  `idpadre` int(11) NOT NULL,
  `nombre` varchar(255) NOT NULL,
  `nombre_espanol` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_productos_colecciones` (
`id` int(11) NOT NULL,
  `nombre` varchar(255) NOT NULL,
  `nombre_espanol` varchar(255) NOT NULL,
  `tags` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_productos_galeria` (
`id` int(11) NOT NULL,
  `idproducto` int(11) NOT NULL,
  `tipo` int(11) NOT NULL COMMENT '0=img; 1=video',
  `principal` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_publicidad` (
`id` int(11) NOT NULL,
  `nombre` varchar(255) NOT NULL,
  `descripcion` text NOT NULL,
  `url` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_publicidad_clic` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_publicidad_impresiones` (
`id` int(11) NOT NULL,
  `idpublicidad` int(11) NOT NULL,
  `pais` varchar(255) NOT NULL,
  `anio` varchar(4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_sessions_web` (
  `session_id` varchar(40) NOT NULL DEFAULT '0',
  `ip_address` varchar(45) NOT NULL DEFAULT '0',
  `user_agent` varchar(120) NOT NULL,
  `last_activity` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `im_slideshow` (
`id` int(11) NOT NULL,
  `titulo` varchar(255) NOT NULL,
  `descripcion` text NOT NULL,
  `titulo_espanol` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_usuarios` (
`id` int(11) NOT NULL,
  `nombre` varchar(255) NOT NULL,
  `tags` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `im_usuarios_privilegios` (
`id` int(11) NOT NULL,
  `idusuario` int(11) NOT NULL,
  `idmodulo` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `im_visitas` (
`id` int(11) NOT NULL,
